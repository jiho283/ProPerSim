...
class Scratch: 
  def __init__(self, f_saved): 
    ...
    self.planned_path = []
    # <suggestion> should be helpful for user's current action 
  ...
  def save(self, out_json):
    ...
    scratch['suggestion'] = self.suggestion
    scratch['user_action_for_suggestion'] = self.user_action_for_suggestion
    scratch['suggestion_eval_result'] = self.suggestion_eval_result
  ...
  def get_suggestion_results(self):
    return self.suggestion, self.user_action_for_suggestion, self.suggestion_eval_result
