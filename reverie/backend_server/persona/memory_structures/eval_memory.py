...
class EvaluationMemory: 
  def __init__(self, f_saved): 
    ...
    for count in range(len(nodes_load.keys())): 
      ...
      if node_type == "event": 
        self.add_event(created, expiration, 
                   description, keywords, poignancy, embedding_pair, filling)
      elif node_type == "thought": 
        self.add_thought(created, expiration, 
                   description, keywords, poignancy, embedding_pair, filling)
  ...
  def add_event(self, created, expiration, description, keywords, poignancy, 
    ...
    # Creating the <EvalConceptNode> object.
    node = EvalConceptNode(node_id, node_count, type_count, node_type, depth,
                       created, expiration, 
  ...
  def add_thought(self, created, expiration, 
