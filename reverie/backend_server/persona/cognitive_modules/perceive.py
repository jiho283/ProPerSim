...
def perceive(persona, maze, client=None): 
  """
  ...
  for p_event in perceived_events: 
    ...
    p_event = (s, p, o)
    if 'sleeping' in str(o) or 'sleeping' in str(desc) or 'suggestion' in str(o) or 'suggestion' in str(desc) or 'sleeping' in str(persona.scratch.act_description):
      continue
    ...
    if p_event not in latest_events:
      ...
      event_poignancy = generate_poig_score(persona, 
                                            "event", 
                                            desc_embedding_in, client=client)
      ...
      if 'eddy' in str(s).lower() and 'suggestion' in str(desc).lower():
        continue
